...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 ExpSyn /home/hegan/packages/nrn_modify/src/nrnoc/expsyn.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/hegan/packages/nrn_modify/src/nrnoc/expsyn.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
