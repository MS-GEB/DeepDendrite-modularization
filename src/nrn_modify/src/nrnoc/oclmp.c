...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 OClamp /home/hegan/packages/nrn_modify/src/nrnoc/oclmp.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/hegan/packages/nrn_modify/src/nrnoc/oclmp.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
