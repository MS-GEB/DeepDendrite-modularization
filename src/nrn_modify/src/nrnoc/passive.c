...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 5, 0);
 	...
 	ivoc_help("help ?1 pas /home/hegan/packages/nrn_modify/src/nrnoc/passive.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/hegan/packages/nrn_modify/src/nrnoc/passive.mod";
static const char* nmodl_file_text = 
