...
struct ThreadMapping
{
    ...
    std::unordered_map<std::string, size_t> map_name2idx;
    size_t ncell;
    ...
    void add_cell_mapping(MyCellMapping* m)
    {
        ...
        map_name2idx[m->cell_name] = ncell;
        ncell++;
    }
    ...
    MyCellMapping* get_cell_map(std::string name)
    {
        ...
        //}
        if (map_name2idx.find(name) != map_name2idx.end())
            return vec_cellmap[map_name2idx[name]];
        else
            return NULL;
    }
